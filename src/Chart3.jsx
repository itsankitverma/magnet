...
import t1data from "./json/Fourth.json";
...
export default function Datafet() {
  ...
  // function Trials() {
  let url = "https://sigview.sigmoid.io/api/v1/getData";
  ...
  return (
    <>
      <span className="chart3">
        <div className="c3">CHART 3</div>
        <Chart
          width={"700px"}
          height={"400px"}
          chartType="BarChart"
          loader={<div>Loading Chart</div>}
          data={[
            ["advertiserId", "CM001", "CM001_percent"],
            [c, b, a],
          ]}
          options={{
